...
@Component({
  selector: 'app-validations-choose-replacement',
  templateUrl: './validations-choose.component.html',
  styleUrls: ['./validations-choose.component.scss']
})
export class ValidationsChooseReplacementComponent implements OnInit {
